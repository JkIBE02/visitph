      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Seafood Soup</p>

            <img src="./assets/images/seafood_soup" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
            Seafood soup is a flavorful soup made with seafood, vegetables, and seasonings. It's often served with rice or bread.
            </p>
            ...
            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/seafood_soup">
              <input type="hidden" name="description" value="Seafood Soup.">
