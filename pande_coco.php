      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Pande Coco</p>

            <img src="./assets/images/pandecoco" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
            Pan de Coco recipe is for the Filipino version from my childhood. Filipino Pan de Coco is a simple milk bread filled with a sweet coconut. Pan de Coco filling is made of shredded coconut, oil (also coconut), and sugar with a dash of salt. 
            </p>
            ...
            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/pandecoco">
              <input type="hidden" name="description" value="Pande Coco.">
