      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Ifugao</p>
            <img src="./assets/images/banaue_top10" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
                The Banaue Rice Terraces, located in Ifugao Province, are a breathtaking testament to the ingenuity and resilience of the Ifugao people. Often called the "Eighth Wonder of the World," these 2,000-year-old terraces were hand-carved into the mountains of the Cordilleras and remain a UNESCO World Heritage Site. The terraces, fed by an intricate irrigation system from mountain springs, showcase sustainable farming practices that have been passed down through generations.
            </p>

            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/ifugao_top10.jpg">
              <input type="hidden" name="description" value="Ifugao.">
