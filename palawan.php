      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Palawan</p>

            <img src="./assets/images/palawan_top10.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
                Puerto Princesa, the capital of Palawan, is a city known for its lush greenery, crystal-clear waters, and dedication to environmental preservation. Dubbed the "City in a Forest," it is home to stunning natural wonders like the UNESCO-listed Underground River, where visitors can explore limestone caves by boat. The city also offers exciting activities such as island hopping in Honda Bay, firefly watching along the Iwahig River, and a visit to Baker’s Hill for picturesque views and tasty baked treats.
            </p>
            ...
            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/palawan_top10.jpg">
              <input type="hidden" name="description" value="Palawan is known for its beautiful beaches and stunning landscapes.">
             ...
             <!-- <div class="btn-group">
              <a href="contact_us.php" class="btn btn-primary">Add to favorite</a> -->
            ...
            <br>
             ...
             <!-- <div class="btn-group">
              <a href="contact_us.php" class="btn btn-primary">Share</a>
            </div> -->
