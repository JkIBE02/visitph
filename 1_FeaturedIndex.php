...
// Fetch destinations
$sql = "SELECT id, title, name, image_filename FROM products WHERE category_type = 1";
...
<section class="section destination">
  <div class="container">
        ...
        <ul class="destination-list">
          <?php while ($row = $result->fetch_assoc()) { ?>
            <li class="w-50">
                ...
                <!-- Delete Button -->
                <form action="1_FeaturedDelete.php" method="POST" style="margin-top: 10px;">
        ...
        <a href="1_AddFeatured.php" class="btn btn-primary">Add Featured</a>
  </div>
...
<div id="uploadModal" class="modal">
    <div class="modal-content">
        ...
        <form action="upload_destinations.php" method="POST" enctype="multipart/form-data">
            <label>Title:</label>
