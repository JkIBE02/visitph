      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Manila</p>
            <img src="./assets/images/intramuros_top10.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
                Intramuros, known as the "Walled City," is the historic heart of Manila and a living testament to the Philippines’ Spanish colonial past. Built in the late 16th century, this iconic district is surrounded by fortified walls and is home to cobblestone streets, centuries-old churches, and heritage structures that transport visitors back in time. Intramuros was the political, cultural, and religious center of Spanish rule in the Philippines.
            </p>

            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/intramuros_top10.jpg">
              <input type="hidden" name="description" value="Manila">
