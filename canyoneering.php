      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Canyoneering</p>

            <img src="./assets/images/canyoneering.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
            Canyoneering is the sport of exploring canyons using a variety of techniques, including climbing, rappelling, swimming, and jumping. It's often done in remote, rugged areas and can involve navigating waterfalls, streams, and pool.
            </p>
            ...
            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/canyoneering.jpg">
              <input type="hidden" name="description" value="Canyoneering.">
