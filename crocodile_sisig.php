      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Crocodile Sisig</p>

            <img src="./assets/images/crocodile_sisig" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
            Crocodile sisig is a Filipino dish made from crocodile meat that's similar to pork sisig in taste and texture. It's a popular delicacy in Palawan.
            </p>
            ...
            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/crocodile_sisig">
              <input type="hidden" name="description" value="Crocodile Sisig.">
