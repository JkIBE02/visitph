      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Siargao</p>
            <img src="./assets/images/Siargao_top10.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
                Siargao, known as the "Surfing Capital of the Philippines," is a tear-shaped island in Surigao del Norte celebrated for its pristine beaches, lush landscapes, and laid-back vibe. The island is a haven for surfers, with Cloud 9 being its most famous surf break, attracting enthusiasts from around the world. Beyond surfing, Siargao offers a range of activities, including island hopping to destinations like Naked Island, Daku Island, and Guyam Island, as well as kayaking, paddleboarding, and swimming in crystal-clear waters.
            </p>
            
            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/siargao_top10.jpg">
              <input type="hidden" name="description" value="Siargao">
