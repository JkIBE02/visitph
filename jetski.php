      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Jet Ski</p>

            <img src="./assets/images/jet_ski.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
            You can ride a jet ski through the waters around popular Philippine islands like Boracay or Panglao, experiencing the thrill of high speed while taking in stunning coastal views, with qualified instructors providing safety guidance.
            </p>
            ...
            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/jet_ski.jpg">
              <input type="hidden" name="description" value="Jet Ski.">
