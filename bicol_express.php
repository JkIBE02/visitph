      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Bicol Express</p>

            <img src="./assets/images/bicol_express.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
            Bicol express is a spicy Filipino stew made with pork, coconut milk, shrimp paste, and chilies. It's a popular dish in the Philippines and is often served with rice and vegetables.
            </p>
            ...
            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/bicol_express.jpg">
              <input type="hidden" name="description" value="Bicol Express.">
