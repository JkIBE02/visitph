      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Sulu Sea</p>
            <img src="./assets/images/tubbataha_top10.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
                Tubbataha Reefs Natural Park, located in the Sulu Sea, is a UNESCO World Heritage Site renowned for its rich marine biodiversity and pristine coral reefs. The park is made up of two atolls—Tubbataha Reef and the smaller Jessie Beazley Reef—along with a number of surrounding islets. Covering over 130,000 hectares, it is one of the most biodiverse marine ecosystems in the world, home to a vast array of marine life, including over 600 species of fish, 360 species of coral, and numerous species of seabirds, sharks, and turtles.
            </p>

            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/sulu_top10.jpg">
              <input type="hidden" name="description" value="Sulu.">
