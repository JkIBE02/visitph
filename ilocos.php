      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Ilocos Sur</p>
            <img src="./assets/images/vigan_top10.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
                Vigan, located in the province of Ilocos Sur, is a well-preserved Spanish colonial town that offers a step back in time. Known for its cobblestone streets, ancestral houses, and heritage architecture, Vigan is a UNESCO World Heritage Site and one of the best examples of a Spanish colonial town in Southeast Asia. The town’s charm lies in its preserved Spanish-era buildings, many of which have been converted into museums, cafes, and boutiques, allowing visitors to experience the history and culture of the region.
            </p>

            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/ilocos_sur_top10.jpg">
              <input type="hidden" name="description" value="Ilocos.">
              <input type="hidden" name="author" value="<?php echo $_SESSION['author'] ?? 'Guest'; ?>"> 
