      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Batanes</p>
            <img src="./assets/images/batanes_top10.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
                Batanes, the northernmost province of the Philippines, is a hidden gem known for its stunning landscapes, traditional Ivatan culture, and tranquil atmosphere. This group of islands, including Batan, Sabtang, and Itbayat, offers breathtaking views of rolling hills, dramatic cliffs, and crystal-clear waters. Batanes is a place where time seems to slow down, with its peaceful, scenic environment and well-preserved heritage.
            </p>
