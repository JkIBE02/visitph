      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Aklan</p>
            <img src="./assets/images/boracay_top10.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
                Boracay, a small island in the Philippines, is world-famous for its powdery white sand beaches and crystal-clear waters, making it a paradise for beach lovers and adventurers. Located in the province of Aklan, the island is best known for White Beach, a 4-kilometer stretch of pristine sand lined with resorts, restaurants, and vibrant nightlife. For thrill-seekers, Boracay offers water sports like kiteboarding, parasailing, and diving, along with quieter experiences such as sunset sailing on a paraw.
            </p>

            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/boracay_top10.jpg">
              <input type="hidden" name="description" value="Boracay.">
