      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Northern Palawan</p>
            <img src="./assets/images/kayangan_top10.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
                Kayangan Lake, located on Coron Island in Palawan, is one of the Philippines' most stunning natural wonders. Known for its crystal-clear waters, dramatic limestone cliffs, and lush surroundings, it is often considered one of the cleanest lakes in the country. The lake is part of a protected marine park, surrounded by dense forest and steep cliffs that create a breathtaking, almost mystical atmosphere.
            </p>

            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/kayangan_top10.jpg">
              <input type="hidden" name="description" value="Kayangan.">
