      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Bagnet</p>

            <img src="./assets/images/bagnet.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
            Bagnet is a crispy, deep-fried pork belly dish from the Ilocos region of the Philippines. It's known for its balance of tender meat and crackling skin.
            </p>
            ...
            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/bagnet.jpg">
              <input type="hidden" name="description" value="Bagnet.">
