      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Helmet Dive</p>

            <img src="./assets/images/helmet_dive.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
            The experience will start with a thrilling speed boat ride to the dive location. There, you will put on the oxygen pumped helmet and go through a safety briefing. Then, slowly descend into the water and begin your wonderful discovery of Boracay's stunning dive site.            
          </p>
            ...
            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/helmet_dive.jpg">
              <input type="hidden" name="description" value="Helmet Dive.">
