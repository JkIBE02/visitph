      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Parasailing</p>

            <img src="./assets/images/parasailing.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
            Parasailing is a water sport where you are towed behind a boat while attached to a parachute. It's also known as parascending or parakiting.         
          </p>
            ...
            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/parasailing.jpg">
              <input type="hidden" name="description" value="Parasailing.">
