    ...
    <!--<article>
      ...
      <!-- <section class="section destination">
        <div class="container">
          ...
          <h2 class="h2 section-title">Luzon</h2>
          ...
          <ul class="destination-list">
            ...
            <li class="w-50">
              <a href="#" class="destination-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/whang-od.jpg" width="700" height="1100" loading="lazy"
                    alt="Aklan, Boracay" class="img-cover">
                </figure>

                <div class="card-content">
                  <p class="card-subtitle">Culture</p>

                  <h3 class="h3 card-title">Pambabatok</h3>
                </div>
            ...
            <li class="w-50">
              <a href="#" class="destination-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/bicol-express-2.jpg" class="image-resize" width="100" height="700" loading="lazy"
                    alt="Coron Island, Palawan" class="img-cover">
                </figure>

                <div class="card-content">
                  <p class="card-subtitle">Foods</p>
            ...
            <li>
              <a href="#" class="destination-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/" width="1110" height="480" loading="lazy"
                    alt="Puerto Princesa, Palawan" class="img-cover">
                </figure>

                <div class="card-content">
                  <p class="card-subtitle">Activities</p>
           ...
           <!-- <li>
              <a href="#" class="destination-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/verde_island.jpg" width="1110" height="480" loading="lazy"
            ...
            <li>
              <a href="#" class="destination-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/bambike-tours.jpg" width="1110" height="480" loading="lazy"
                    alt="Bamble tours" class="img-cover">
                </figure>

                <div class="card-content">
                  <p class="card-subtitle">Activities</p>

                  <h3 class="h3 card-title">Bambike tours</h3>
                </div>
      ...
      <section class="section destination">
        ...
        <p class="section-subtitle">Destinations</p>
          ...
          <h2 class="h2 section-title">Visayas</h2>
          ...
          <ul class="destination-list">
            ...
            <li class="w-50">
              <a href="#" class="destination-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/sinulog-festival.jpg" width="1140" height="1100" loading="lazy"
                    alt="Aklan, Boracay" class="img-cover">
                </figure>
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3 card-title">Sinulog festival</h3>
                </div>
            ...
            <li class="w-50">
              <a href="#" class="destination-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/Lechon.jpg" width="1140" height="1100" loading="lazy"
                    alt="Lechon" class="img-cover">
                </figure>

                <div class="card-content">
                  <p class="card-subtitle">Foods</p>

                  <h3 class="h3 card-title">Lechon</h3>
                </div>
            ...
            <li>
              <a href="#" class="destination-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/canyoneering.jpg" width="1110" height="480" loading="lazy"
           ...
           <li>
            ...
            <!--<li>
              <a href="#" class="destination-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/Hinatuan_enchanted_river.jpg" width="1110" height="480" loading="lazy"
      ...
      <section class="section destination">
        <div class="container">
          ...
          <h2 class="h2 section-title">Mindanao</h2>
          ...
          <ul class="destination-list">
            ...
            <li class="w-50">
              <a href="#" class="destination-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/Kadayawan_Festival_1.jpg" width="1140" height="1100" loading="lazy"
                    alt="Kadayawan" class="img-cover">
                </figure>

                <div class="card-content">
                  <p class="card-subtitle">Culture</p>

                  <h3 class="h3 card-title">Kadayawan festival</h3>
                </div>
            ...
            <li class="w-50">
              <a href="#" class="destination-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/biryani.jpg" width="1140" height="1100" loading="lazy"
                    alt="Biryani" class="img-cover">
                </figure>

                <div class="card-content">
                  <p class="card-subtitle">Foods</p>

                  <h3 class="h3 card-title">Biryani</h3>
                </div>
            ...
            <li>
              <a href="#" class="destination-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/habal-habal.jpg" width="1110" height="480" loading="lazy"
                    alt="Habal-habal" class="img-cover">
                </figure>

                <div class="card-content">
                  <p class="card-subtitle">Activities</p>

                  <h3 class="h3 card-title">Habal-habal</h3>
                </div>
    ...
    <div class="container">
      ...
      <div class="footer-top">
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-title">Culture</p>
          </li>
