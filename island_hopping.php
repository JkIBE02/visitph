      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Island Hopping</p>

            <img src="./assets/images/island_hopping.jpg" class="top10">

            <h2 class="hero-title"></h2>

            <p class="hero-text">
            Island hopping involves visiting multiple islands and places in one trip. This can be done on a boat or yacht. It’s a great way for people to visit different landscapes and cultures in a short amount of time.            
          </p>
            ...
            <form action="share_post.php" method="POST">
              <input type="hidden" name="image" value="http://localhost/GROUP9/assets/images/island_hopping.jpg">
              <input type="hidden" name="description" value="Island Hopping.">
